...
| NOM-TE-UNCERTAINTY-120K | support/reliability/evidence metadata improves exact-value target encoding | S1 replicated screen | **-0.000222 mean** | n/a | 1/3 seeds | **KILL** | Deltas -0.000449, -0.000232, +0.000016. Posterior mean is useful; explicit confidence metadata is not. |
| NOM-TE-INNER10-120K | 10 nested TE folds beats 5 nested TE folds standalone | S1 replicated screen | **-0.000069 mean** | n/a | 0/3 seeds | **KEEP INNER-5 DEFAULT** | Inner-10 remained useful later as a separate full-data ensemble stream, not as a universal standalone upgrade. |
| NOM-TE-CAPACITY-120K | strong TE representation is still improving from 1200 to 2000 trees at S1 scale | S1 capacity screen | **-0.000352 mean** | n/a | 0/3 seeds | **PLATEAU / OVERFIT BY 2000** | Mean 1200-600=-0.000090; tree-count optimum depends strongly on training-set size, so full-data lanes use early stopping. |
| NOM-TE-SMOOTH-120K | smoothing-10 and smoothing-20 provide useful rank diversity | S1 replicated screen | **+0.000184 mean blend gain** | n/a | 3/3 seeds | **ADVANCE** | Fixed 50/50 rank blend beat the better standalone model on every seed. |
| NOM-TE-FULL-I5 | full 691k smoothing-10 inner-5 TE LightGBM/XGBoost frontier | 5-fold full-data routing | **+0.000137 blend vs XGB** | n/a | n/a | **LEADERBOARD CANDIDATE** | LGB=0.967581878; XGB=0.967688247; honest rotating blend=0.967825597; mean LGB weight 0.44. Not S3 promotion evidence. |
| NOM-TE-FULL-I10 | full 691k inner-10 TE LightGBM provides additional ensemble diversity | 5-fold full-data routing | **+0.000179 blend vs inner-10 LGB** | n/a | n/a | **KEEP AS ENSEMBLE STREAM** | Inner-10 LGB=0.967644407; paired with the same XGB stream, honest rotating blend=0.967867071 at mean LGB weight 0.46. |
| NOM-TE-FULL-S20 | full 691k smoothing-20 TE LightGBM is stronger standalone | 5-fold full-data routing | **-0.000011 vs s10/i5 LGB** | n/a | n/a | **DIVERSITY ONLY** | OOF=0.967570470, slightly below s10/i5 LGB. Its replicated value is in blending. |
| NOM-TE-QUAD-V2 | four aligned TE/XGB streams improve the live frontier | 5-fold full-data routing | **+0.000068 vs original live blend** | n/a | n/a | **LEADERBOARD PROBE** | Honest rotating-fold AUC=0.967893241. Mean weights 0.15 s10/i5 LGB, 0.44 XGB, 0.26 s10/i10 LGB, 0.15 s20/i5 LGB. Submission SHA-256 `3d714f3ab11584e1df9066afea0875ebba689513dd94c018be4b47c950740ede`. |
